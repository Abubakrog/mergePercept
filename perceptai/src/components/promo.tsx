...
export default function Promo() {
    const { user } = useUser();
    const isAdmin = user?.emailAddresses?.some(email => email.emailAddress === "admin@perceptai.com");

    return (
        <div className="min-h-[40vh]  flex items-center justify-center p-4  bg-[#000]">
            <Card className="w-full max-w-4xl bg-[#000] border-none">
