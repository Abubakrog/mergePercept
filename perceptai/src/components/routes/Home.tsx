  ...
  <div className="container">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
      ...
      <Card className="bg-[#121212] border border-[#1f1f1f] shadow-lg rounded-lg backdrop-blur-lg">
        ...
        {[
          { src: "https://ui-avatars.com/api/?name=Abubakar", fallback: "AB" },
          { src: "https://ui-avatars.com/api/?name=Moin", fallback: "MO" },
          { src: "https://ui-avatars.com/api/?name=Shivam", fallback: "SH" },
      ...
      {[
        {
          ...
          link: "https://en.wikipedia.org/wiki/3D_reconstruction"
        },
        {
          ...
          link: "https://en.wikipedia.org/wiki/Vision%E2%80%93language_model"
        },
        {
          ...
          link: "https://en.wikipedia.org/wiki/Edge_computing#Edge_AI"
        },
        {
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-1">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-xl font-semibold text-white mb-2 group-hover:text-purple-400 
            ...
            <div className="flex flex-col md:items-end justify-between">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-4 px-4 py-2 rounded-lg bg-[#67656576] text-white 
              border-gray-500 hover:bg-purple-500 transition-all duration-300 text-center"
              >
                Read Paper
              </a>
            </div>
