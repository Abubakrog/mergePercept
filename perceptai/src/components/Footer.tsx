...
const SocialMedia: React.FC = () => (
    <div>
        ...
        <div className="flex space-x-4">
            {[
                { Icon: FaGithub, link: 'https://github.com/perceptai' },
                { Icon: FaTwitter, link: 'https://twitter.com/percept_ai' },
                { Icon: FaLinkedin, link: 'https://linkedin.com/company/perceptai' },
                { Icon: FaInstagram, link: 'https://instagram.com/percept_ai' },
            ].map(({ Icon, link }) => (
                <a
                    key={link}
                    href={link}
