...
const Chat: React.FC = () => {
  ...
  const [onlineUsers, setOnlineUsers] = useState<User[]>([
    { id: "1", username: "abubakar", userImageUrl: "https://ui-avatars.com/api/?name=Abubakar" },
    { id: "2", username: "moin", userImageUrl: "https://ui-avatars.com/api/?name=Moin" },
    { id: "3", username: "shivam", userImageUrl: "https://ui-avatars.com/api/?name=Shivam" },
  ]);
